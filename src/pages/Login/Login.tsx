    ...
    <div className="bg-slate-200 pt-28 pb-8">
      ...
      >
        <div className="flex flex-col gap-6 text-center">
          ...
          />
          <button className="w-full border-2 border-black bg-primary py-4 uppercase text-white transition-colors duration-300">
            Login
          </button>
          ...
          <button className="w-full border-2 bg-red-500 py-4 uppercase text-white transition-colors duration-300">
            Google
          </button>
