    ...
    <section className="pt-20">
      <div className="px-6 py-8">
        <div className="flex flex-col sm:flex-row items-center">
          <div className="w-full flex-col justify-center sm:pr-4 md:pr-6 lg:pr-8 sm:flex">
            <h2 className="lg:text-6xl mb-2 text-4xl font-bold md:text-5xl">Jerrell Store</h2>
            <h3 className="mb-4 text-xl font-medium text-dark md:text-3xl lg:text-3xl">Lorem, ipsum dolor.</h3>
            ...
            <Link to="/products">
              <button className="uppercase bg-primary mt-4 w-full py-4 text-white border-2 border-black transition-colors duration-300 hover:text-black hover:bg-white">start shopping</button>
            </Link>
          </div>
