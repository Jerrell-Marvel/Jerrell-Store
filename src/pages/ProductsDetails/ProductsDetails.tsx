    ...
    <>
      <section className="bg-slate-50 px-6 pt-20 pb-6">
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-1/2">{loading ? <div className="h-full w-full animate-loading bg-slate-200"></div> : <img src={itemDetails?.data.imageUrl} alt={itemDetails?.data.title} />}</div>

          <div className="w-full md:w-1/2 md:pl-8">
            <h2 className="mb-4 mt-8 text-2xl font-medium uppercase md:mt-0 lg:text-4xl">{itemDetails?.data.title}</h2>
