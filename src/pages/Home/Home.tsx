...
function Home() {
  return (
    <div id="home" className="pt-20">
      ...
      <ShowProducts amount={10} url="https://api.spaceflightnewsapi.net/v3/articles" title="Category 1" />

      <HomeBanner src="https://source.unsplash.com/random/1600x1101">Popular Items</HomeBanner>
      <ShowProducts amount={10} url="https://api.spaceflightnewsapi.net/v3/articles" title="Category 2" />
