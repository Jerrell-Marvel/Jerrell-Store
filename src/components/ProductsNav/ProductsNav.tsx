...
function ProductsNav() {
  return (
    <>
      <div className="relative flex h-[40vh] w-full items-center justify-center bg-[url('https://source.unsplash.com/random/800x300')] bg-cover px-6 pt-20 text-center after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:bg-slate-800 after:opacity-40 after:content-[''] lg:h-[50vh]">
